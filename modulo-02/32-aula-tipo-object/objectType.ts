...
function onboarding02(pessoa: Pessoa) {
  return(
    `Seja bem-vinda ${pessoa.nome}! Sua função aqui na empresa será ${pessoa.funcao}`
  );
};
...
function onboarding03(pessoa: Pessoa03) {
  return(
    `Seja bem-vinda ${pessoa.nome}! Sua função aqui na empresa será ${pessoa.funcao}. Você trabalhará com a linguagem ${pessoa.linguagem}.`
  );
};
...
function onboarding05(pessoa: Pessoa04) {
  return(
    `Seja bem-vinda ${pessoa.nome}! Sua função aqui na empresa será ${pessoa.funcao}. Você trabalhará com a linguagem ${pessoa.linguagem}. Seu e-mail será ${pessoa.email}`
  );
};
